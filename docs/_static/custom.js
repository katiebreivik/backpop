document.addEventListener("DOMContentLoaded", function() {
    ...
    // replace "BackPop Repo" logo with github icon
    const repoLink = document.querySelector('.md-source__icon');
    if (repoLink) {
        repoLink.innerHTML = `<svg height="32" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true">
